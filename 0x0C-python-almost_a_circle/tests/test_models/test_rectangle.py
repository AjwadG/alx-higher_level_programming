...
and 'height'"
    ...
    def test_4_constructor_to_many_args(self):
        '''Tests constructor with to many args.'''
        with self.assertRaises(TypeError) as e:
...
given"
    ...
    def test_5_constructor_one_arg(self):
        '''Tests constructor with one arg.'''
        with self.assertRaises(TypeError) as e:
            r = Rectangle(1)
    ...
    def test_7_instantiation_positional(self):
    ...
    def test_8_instantiation_keyword(self):
        '''Tests positional instantiation.'''
    ...
    def test_13_value_negative(self):
        '''Tests property validation.neg value'''
        r = Rectangle(1, 2)
    ...
    def test_14_validate_value_negative(self):
        '''Tests property validation.neg value'''
        r = Rectangle(1, 2)
        attributes = ["x", "y"]
        for attribute in attributes:
    ...
    # ----------------- Tests for #5 & #7 ------------------------
    def test_20_display_no_obj(self):
    ...
    def test_21_display_simple(self):
...
"""
    ...
    def test_22_str_no_obj(self):
        '''Tests __str__() method no oobj.'''
        r = Rectangle(5, 2)
        with self.assertRaises(TypeError) as e:
            Rectangle.__str__()
    ...
    def test_23_str(self):
        ...
        # ----------------- Tests for #8 & #9 ------------------------
    def test_24_update_no_obj(self):
        '''Tests update() method no obj.'''
        r = Rectangle(5, 2)
        with self.assertRaises(TypeError) as e:
            Rectangle.update()
    ...
    def test_28_update_kwargs_2(self):
        '''Tests update() keyword args.'''
        r = Rectangle(5, 2)
        d = r.__dict__.copy()
        ...
        r1.update(y=1, width=2, x=3, id=55)
        self.assertEqual(str(r1), "[Rectangle] (55) 3/1 - 2/1")

        r1.update(x=1, height=2, y=3, width=4)
        self.assertEqual(str(r1), "[Rectangle] (55) 1/3 - 4/2")
        ...
        r1.update(55)
        self.assertEqual(str(r1), "[Rectangle] (55) 10/10 - 10/10")

        r1.update(55, 2)
        self.assertEqual(str(r1), "[Rectangle] (55) 10/10 - 2/10")

        r1.update(55, 2, 3)
        self.assertEqual(str(r1), "[Rectangle] (55) 10/10 - 2/3")

        r1.update(55, 2, 3, 4)
        self.assertEqual(str(r1), "[Rectangle] (55) 4/10 - 2/3")

        r1.update(55, 2, 3, 4, 5)
        self.assertEqual(str(r1), "[Rectangle] (55) 4/5 - 2/3")

    # ----------------- Tests for #13 ------------------------
    def test_29_to_dictionary(self):
        '''Tests to_dictionary() no obj:'''
        with self.assertRaises(TypeError) as e:
